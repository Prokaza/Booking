...
<head>
  ...
  <title><spring:message code="message.personlRoom" /></title>
...
<div id="container">
  ...
  <div id="content">
    <form:form method="POST" modelAttribute="user" cssClass="form" action="/personal_account/save/${user.id}">
      <fieldset class="fieldset">
        <legend><spring:message code="message.personlRoom" /></legend>
        <fieldset class="fieldset_info">
          ...
          <form:input path="email" required = "true" placeholder = "email" cssClass="input"/>
          ...
          <form:label path="birthday"><em><spring:message code="message.birthday"/></em></form:label>
        ...
        <select onchange="top.location=this.value" class="select pers_acc_select">
          <option >
            <spring:message code="message.selectAction" />
          </option>
          <option value="<c:url value="/personal_account/save/${user.id}"/>">
              <spring:message code="message.save" />
            </option>
          <option value="<c:url value="/personal_account/change_email" />">
            <spring:message code="message.changePassword" />
          </option>
          <option value="<c:url value="/personal_account/delete/${user.id}" />">
            <spring:message code="message.delete" />
          </option>
          <option value="<c:url value="/cancel" />">
